                 ...
                 otherButtonTitles:(NSString *)otherButtonTitles,...
{
    ...
    va_end(params);
    return [self sf_alertWithTitle:title message:message completion:completion cancleButtonTitle:cancleButtonTitle otherButtonTitleList:titleList];
}
...
{
    return [self sf_confirmWithTitle:title message:message approve:approve cancle:nil];
}

+ (UIAlertView *)sf_confirmWithTitle:(NSString *)title message:(NSString *)message approve:(void(^)())approve cancle:(void(^)())cancle
{
    return [self sf_alertWithTitle:title message:message completion:^(NSInteger buttonIndex, NSString *buttonTitle) {
        if (buttonIndex == 0) {
            if (cancle) {
...
{
    return [self sf_inputWithTitle:title message:message secureTextEntry:NO canaleButtonTitle:canaleButtonTitle approveButtonTitle:approveButtonTitle completion:completion];
}
